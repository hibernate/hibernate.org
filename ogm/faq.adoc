...
Check out the https://docs.hibernate.org/ogm/4.2/reference/en-US/html_single/#ogm-api-error-handler[reference guide]
...
See the https://docs.hibernate.org/ogm/4.1/reference/en-US/html_single/#ogm-configuration-jbossmodule[reference guide] to learn more.
...
https://docs.hibernate.org/stable/ogm/reference/en-US/html/ch02.html[getting started chapter of the documentation].
