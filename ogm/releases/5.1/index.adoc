...
OGM 5.1 supports https://docs.mongodb.com/manual/aggregation/#aggregation-pipeline[aggregation] in MongoDB native queries using the https://docs.hibernate.org/stable/ogm/reference/en-US/html_single/#ogm-mongodb-cli-syntax[CLI syntax].
