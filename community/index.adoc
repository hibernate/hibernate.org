...
NOTE: To report security issues, please follow instructions found https://github.com/hibernate/.github/security/policy[here].
...
link:/community/contribute[Contributing guidelines]::
...
https://github.com/search?q=org%3Ahibernate%20is%3Aissue&type=issues[GitHub issue tracker]::
Some projects, in particular Hibernate Reactive, use GitHub issues for task reporting and tracking.
In particular look for the ones marked as https://github.com/search?q=org%3Ahibernate+is%3Aissue+label%3A%22good+first+issue%22+is%3Aopen&type=issues[good first issues].
+
NOTE: For security issues, please do not use our (public) issue tracker.
Instead, follow instructions found https://github.com/hibernate/.github/security/policy[here].
