...
https://docs.hibernate.org/search/5.6/reference/en-US/html_single/#elasticsearch-integration[Elasticsearch chapter]
...
and in
https://docs.hibernate.org/search/5.6/reference/en-US/html_single/#query-sorting[the documentation]
...
Refer to https://docs.hibernate.org/search/5.6/reference/en-US/html_single/#search-architecture-readerstrategy[the documentation]
