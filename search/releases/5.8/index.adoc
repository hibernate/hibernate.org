...
Details about this feature are available https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#_simple_query_string_queries[in the documentation],
...
See also the https://docs.hibernate.org/orm/5.2/userguide/html_single/Hibernate_User_Guide.html#jndi[JNDI configuration in the Hibernate ORM documentation].
...
https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#section-programmatic-analyzer-definition[here for Lucene]
and https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#_custom_analyzers_using_a_definition_provider[here for Elasticsearch].
 ...
 * https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#section-normalizers[main documentation]
 * https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#_normalizers[Elasticsearch specifics]
...
https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#elasticsearch-integration-configuration-aws[reference documentation].
