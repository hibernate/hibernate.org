...
See https://docs.hibernate.org/search/5.9/reference/en-US/html_single/#jsr352-integration[the documentation]
...
See https://docs.hibernate.org/search/5.9/reference/en-US/html_single/#search-configuration-deploy-on-wildfly[the documentation]
