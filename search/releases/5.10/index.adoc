...
https://docs.hibernate.org/search/5.10/reference/en-US/html_single/#_jgroups_feature_pack[a dedicated feature pack].
...
See the https://docs.hibernate.org/search/5.10/reference/en-US/html_single/#elasticsearch-client-access[documentation]
