...
* it respects the project code style - find templates for link:/community/contribute/eclipse-ide[Eclipse] and link:/community/contribute/intellij-idea[IntelliJ IDEA]
...
Find how to join them link:/community/#contribute[here].
