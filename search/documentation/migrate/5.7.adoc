...
Make sure you read the related chapters of both projects to update the WildFly modules:
 ...
 - https://docs.hibernate.org/search/5.7/reference/en-US/html_single/#_deploying_on_wildfly[Hibernate Search updated modules on WildFly 10]
 - https://docs.hibernate.org/orm/5.2/topical/html_single/wildfly/Wildfly.html[Hibernate ORM modules on WildFly 10]
