...
`link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/bridge/builtin/IntegerBridge.html[org.hibernate.search.bridge.builtin.IntegerBridge]`.
Check the package `link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/bridge/builtin/package-summary.html[org.hibernate.search.bridge.builtin]` for
other publicly available field bridges.

For dates and calendars you can switch the indexing format via the new
`link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/annotations/EncodingType.html[EncodingType]`
...
`link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/engine/service/spi/ServiceManager.html[ServiceManager]`,
`link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/engine/service/spi/Service.html[Service]`,
`link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/engine/service/spi/Startable.html[Startable]`
and `link:https://docs.hibernate.org/search/5.0/api/org/hibernate/search/engine/service/spi/Stoppable.html[Stoppable]`
