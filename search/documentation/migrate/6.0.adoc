...
:reference_version_full: 6.0.0.Beta8
...
See link:https://docs.jboss.org/hibernate/search/6.0/reference/en-US/html_single/#configuration-bean[the section of the documentation about beans in Hibernate Search]
...
link:https://docs.jboss.org/hibernate/search/6.0/reference/en-US/html_single/#mapper-orm-bridge-valuebridge-valuebinder[`ValueBinder`],
link:https://docs.jboss.org/hibernate/search/6.0/reference/en-US/html_single/#mapper-orm-bridge-propertybridge[`PropertyBinder`],
link:https://docs.jboss.org/hibernate/search/6.0/reference/en-US/html_single/#mapper-orm-bridge-typebridge[`TypeBinder`].

Full-text filters::
These no longer exist in Hibernate Search 6.
See https://hibernate.atlassian.net/browse/HSEARCH-3325[HSEARCH-3325].

Programmatic mapping::
`@Factory` is no longer needed for the programmatic mapping,
since you will pass a callback (link:https://docs.jboss.org/hibernate/search/6.0/reference/en-US/html_single/#_configuring_the_mapping[`HibernateOrmSearchMappingConfigurer`])
...
Analysis definition providers are now called link:https://docs.jboss.org/hibernate/search/6.0/reference/en-US/html_single/#backend-lucene-analysis[analysis configurers],
