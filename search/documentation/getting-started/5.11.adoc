...
:latest_stable_series_version: #{latest_stable_series(page).version}
:docs_base_url: https://docs.hibernate.org/search/5.11/reference/en-US/html_single/

WARNING: This document covers the latest stable release of Hibernate Search 5.
If you're looking for a getting started guide for the latest stable series, Hibernate Search {latest_stable_series_version},
see link:/search/releases/{latest_stable_series_version}/#getting_started[here].
...
Hibernate ORM::
You will need `hibernate-core` version 5.4 and its transitive dependencies.
See link:/orm/releases/5.4/#get-it[here] for information on how to get these.
