...
:docs_base_url: http://docs.jboss.org/hibernate/search/5.0/reference/en-US/html_single/
...
To use the latest Hibernate Search version 5.0 you'll need Java version 7 or greater.
