...
:docs_base_url: http://docs.jboss.org/hibernate/search/5.1/reference/en-US/html_single/
...
To use the latest Hibernate Search version 5.1 you'll need Java version 7 or greater.
