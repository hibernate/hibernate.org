...
Your program can access this information link:https://docs.jboss.org/hibernate/orm/7.0/introduction/html_single/Hibernate_Introduction.html#statistics[via an API], but some environments report it automatically.
...
- link:https://docs.jboss.org/hibernate/orm/{version_family}/userguide/html_single/Hibernate_User_Guide.html#appendix-monitoring-with-JFR[Hibernate JFR] reports persistence-related events to Java Flight Recorder.
