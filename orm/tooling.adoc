...
- the `hibernate-jfr` and `hibernate-micrometer` modules which provide integration with Java Flight Recorder and link:https://github.com/micrometer-metrics/micrometer[Micrometer].
