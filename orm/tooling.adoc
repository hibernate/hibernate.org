...
For more information and setup options refer to the 
link:https://docs.jboss.org/hibernate/orm/{version_family}/userguide/html_single/Hibernate_User_Guide.html#tooling[online documentation].
