...
Hibernate Processor is the thing which provides the implementation of a `@Repository` interface in our implementation of Jakarta Data, link:https://docs.jboss.org/hibernate/orm/{version_family}/repositories/html_single/Hibernate_Data_Repositories.html[Hibernate Data Repositories].
