...
link:https://docs.hibernate.org/orm/4.3/quickstart/en-US/html_single/[Getting Started Guide]::
...
link:https://docs.hibernate.org/orm/4.3/manual/en-US/html_single/[Manual]::
User Guide
link:https://docs.hibernate.org/orm/4.3/devguide/en-US/html_single/[Developer Guide]::
Developer Guide
link:https://docs.hibernate.org/orm/4.3/javadocs/[Hibernate Javadoc]::
