...
link:https://jakarta.ee/specifications/persistence/4.0/[Jakarta Persistence]::
...
link:https://jakarta.ee/specifications/persistence/4.0/apidocs[Jakarta Persistence Javadoc]::
