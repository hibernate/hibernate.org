...
link:{doc-url-base}/quickstart/html_single/[Getting Started]::
    A quickstart-style tutorial. See the _Obtaining Hibernate_ section for information about artifacts and how to obtain them.
...
link:https://jakarta.ee/specifications/persistence/3.2/apidocs/[Jakarta Persistence 3.2 Javadoc]::
    The Jakarta Persistence (3.2) API documentation
