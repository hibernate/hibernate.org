...
[WARNING]
====
The Hibernate ORM 5.3 documentation will be available soon.
====
...
Migration guide covering migration from 5.2 to {awestruct-ormversion}
...
link:http://docs.jboss.org/hibernate/jpa/2.2/api/[JPA 2.1 JavaDoc]::
