...
* Require JDK 25 for the builds. (link:{hv-jira-url-prefix}/HV-2145[HV-2145]).
* Apply the unified Hibernate documentation theme. (link:{hv-jira-url-prefix}/HV-2143[HV-2143]).

For a full list of issues currently planned for this series,
see https://hibernate.atlassian.net/issues/?jql=fixVersion%20=%2033308%20ORDER%20BY%20created%20ASC[here].
