 ...
 * https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#constraint-validator-payload[Constraint validator payload]: ability to pass a payload to your constraint validators
 * Additional constraints: `@ISBN`, `@UniqueElements` and `@CodePointLength`
 * https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#section-clock-provider[Temporal validation tolerance]
