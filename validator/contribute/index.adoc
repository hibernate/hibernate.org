...
You want to implement a new validation feature or you found a bug and want to provide a fix? Awesome! The following get you started working with the Hibernate Validator code base.
