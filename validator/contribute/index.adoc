...
* JDK 8 (The main HV binaries target Java 6 but JDK 8 (>=1.8.0_20) is required for development as
some Java 8 features are optionally implemented as well)
...
The import of the project is easiest, if you follow these steps:

1. After installing m2eclipse, go to: File->Import->Existing Maven projects
...
5. Set the environment JavaSE-1.6 to use JDK 1.8
