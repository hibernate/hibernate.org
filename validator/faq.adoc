...
By implementing a https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#section-class-level-constraints[class-level constraint].
...
Yes, using the https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#section-programmatic-api[API for programmatic constraint declaration].
...
You can do so using the https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#validator-metadata-api[constraint metadata API].
