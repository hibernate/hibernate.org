...
To contribute back to Hibernate Validator you should create a https://help.github.com/articles/fork-a-repo/[fork] of the project into your GitHub account and submit https://help.github.com/articles/creating-a-pull-request/[pull requests] with your changes. For more information on Git, check out https://in.relation.to/2010/10/13/hibernate-moves-to-git-git-tips-and-tricks/[this blog entry].
...
Refer to the Hibernate link:/community/contribute/guidelines#design-philosophy[design philosophy] when working
on new HV features.
...
* https://discourse.hibernate.org/c/bean-validation[Forum for JSR 303/349/380 feeback]
