...
++++
<a class="ui button right labeled icon a primary" href="/nosql/">
  <i class="right arrow icon"></i>
  More about Hibernate NoSQL
</a>
++++
...
Documentation::
Reference documentation as https://docs.hibernate.org/stable/shards/reference/en/html/[html],
https://docs.hibernate.org/stable/shards/reference/en/html_single/[single page html] or
https://docs.hibernate.org/stable/shards/reference/en/pdf/hibernate_shard.pdf[pdf].
https://docs.hibernate.org/stable/shards/api/[Javadoc].
Source code::
